...
export const requiredVariants = [
  ...
  },
  {
    ...
    role: 'web-favicon',
    intendedBackground: 'browser-controlled',
    path: 'platform/web/favicon-48.png',
    platform: 'web',
    width: 48,
    height: 48,
    master: false,
  ...
  {
    id: 'web-touch-icon-180',
    role: 'web-touch-icon',
    intendedBackground: 'system-mask-controlled',
    path: 'platform/web/apple-touch-icon-180.png',
    platform: 'web',
    width: 180,
    height: 180,
    master: false,
  ...
  {
    id: 'web-social-preview-1200x630',
    role: 'social-sharing-image',
    intendedBackground: 'social-card',
    path: 'platform/web/social-preview-1200x630.png',
    platform: 'web',
    width: 1200,
    height: 630,
    master: false,
