...
test('Clozemaster adapter does not contact Supabase directly', async () => {
  const bundle = await readFile('apps/extension/.output/chrome-mv3/content-scripts/clozemaster.js', 'utf8');
